    ...
    def _load_translations(self):
        ...
        return {
            'zh': {
                ...
                # Batch processing
                'side-batch': '批量处理',
                'batch_processing_center': '批量数据处理中心',
                'batch_process_multiple': '同时处理多个数据集，进行对比分析',
                'batch_config': '批量分析配置',
                'select_datasets_batch': '选择数据集 (支持多选):',
                'select_modules_batch': '选择分析模块 (支持多选):',
                'start_batch_analysis': '开始批量分析',
                'batch_history': '批量处理历史',
                'batch_job_id': '作业ID',
                'batch_status': '状态',
                'batch_datasets_count': '数据集数',
                'batch_modules_count': '模块数',
                'batch_created_time': '创建时间',
                'batch_view_results': '查看结果',
                'batch_job_started': '批量处理作业已启动',
                'batch_processing': '处理',
                'batch_running': '运行',
                'batch_analysis_modules': '个分析模块',
                'batch_completed_view': '处理完成后可在批量结果页面查看详情。',
                'batch_launch_failed': '启动失败',
                'batch_job_status': '作业状态',
                'batch_pending': '等待中',
                'batch_running_status': '运行中',
                'batch_completed': '已完成',
                'batch_partial_complete': '部分完成',
                'batch_failed': '失败',
                'batch_report_not_found': '报告文件未找到',
                'batch_load_report_failed': '加载报告失败',
                
                # Task queue
                'side-taskqueue': '任务队列',
                'taskqueue_management_center': '任务队列管理中心',
                'monitor_manage_tasks': '监控和管理分析任务队列',
                'taskqueue_queued': '排队中',
                'taskqueue_running': '运行中',
                'taskqueue_scheduled': '已计划',
                'taskqueue_failed': '失败',
                'taskqueue_system_status': '队列系统状态',
                'celery_status': 'Celery状态',
                'celery_available': '可用',
                'celery_unavailable': '不可用 (使用文件队列)',
                'install_celery_tip': '提示: 安装Celery和Redis以启用高性能任务队列:',
                ...
                'task_dataset': '数据集',
                'task_status': '状态',
                'task_submit_time': '提交时间',
                'task_priority': '优先级',
                'task_action': '操作',
                'task_cancel': '取消',
                'task_view': '查看',
                'refresh_queue_status': '刷新队列状态',
                'task_cancelled': '已取消',
                'task_details': '任务详情'
            },
            ...
            'en': {
                ...
                # Batch processing
                'side-batch': 'Batch Processing',
                'batch_processing_center': 'Batch Data Processing Center',
                'batch_process_multiple': 'Process multiple datasets simultaneously for comparative analysis',
                'batch_config': 'Batch Analysis Configuration',
                'select_datasets_batch': 'Select Datasets (multiple selection supported):',
                'select_modules_batch': 'Select Analysis Modules (multiple selection supported):',
                'start_batch_analysis': 'Start Batch Analysis',
                'batch_history': 'Batch Processing History',
                'batch_job_id': 'Job ID',
                'batch_status': 'Status',
                'batch_datasets_count': 'Datasets',
                'batch_modules_count': 'Modules',
                'batch_created_time': 'Created Time',
                'batch_view_results': 'View Results',
                'batch_job_started': 'Batch processing job started',
                'batch_processing': 'Processing',
                'batch_running': 'Running',
                'batch_analysis_modules': 'analysis modules',
                'batch_completed_view': 'Results will be available on the batch results page after completion.',
                'batch_launch_failed': 'Launch Failed',
                'batch_job_status': 'Job Status',
                'batch_pending': 'Pending',
                'batch_running_status': 'Running',
                'batch_completed': 'Completed',
                'batch_partial_complete': 'Partially Completed',
                'batch_failed': 'Failed',
                'batch_report_not_found': 'Report file not found',
                'batch_load_report_failed': 'Failed to load report',
                
                # Task queue
                'side-taskqueue': 'Task Queue',
                'taskqueue_management_center': 'Task Queue Management Center',
                'monitor_manage_tasks': 'Monitor and manage analysis task queue',
                'taskqueue_queued': 'Queued',
                'taskqueue_running': 'Running',
                'taskqueue_scheduled': 'Scheduled',
                'taskqueue_failed': 'Failed',
                'taskqueue_system_status': 'Queue System Status',
                'celery_status': 'Celery Status',
                'celery_available': 'Available',
                'celery_unavailable': 'Unavailable (using file queue)',
                'install_celery_tip': 'Tip: Install Celery and Redis to enable high-performance task queue:',
                ...
                # Dataset management
                'dataset_management_center': 'Dataset Management Center',
                'dataset_management_description': 'Comprehensive management of your multi-omics datasets, including viewing, editing, analysis and export functions',
                ...
                'search_placeholder': 'Search dataset name, description or tags...',
                'all_types': 'All Types',
                'demo_data': 'Demo Data',
                'user_data': 'User Data',
                ...
                'tags': 'Tags',
                'actions': 'Actions',
                'dataset_status_distribution': 'Dataset Status Distribution',
                
                # Enhanced platform features
                'smart_recommendations': 'Smart Recommendations',
                'intelligent_analysis_recommendations': 'Intelligent Analysis Recommendations',
                'recommended_analysis_workflow': 'Recommended Analysis Workflow',
                'chart_interaction_tools': 'Chart Interaction Tools',
                'enhanced_visualizations': 'Enhanced Visualizations',
                'user_guidance_system': 'User Guidance System',
                ...
                'crossfilter_tool': 'Crossfilter Tool',
                'selected_data_statistics': 'Selected Data Statistics',
                'crossfilter_status': 'Crossfilter Status',
                'chart_export_options': 'Chart Export Options',
                'data_filtering_controls': 'Data Filtering Controls',
                ...
                'analysis_tutorials': 'Analysis Tutorials',
                'help_center': 'Help Center',
                'search_help': 'Search Help',
                'contextual_tips': 'Contextual Tips',
                ...
                'active_analyses': 'Active Analyses',
